...
public class OWLAPIDemo {
	...
	public static void main(String[] args) {
		...
		try {
			testFileIn = FileManager.get().open(
					"U:\\scis\\ASCL\\OntologyandSemantics\\camera.owl");
	...
	public static void parseProperty(OntProperty ontProperty) {
		...
		Iterator<? extends OntProperty> itrSuperProp = ontProperty
				.listSuperProperties();
		...
		Iterator<? extends OntProperty> itrSubProp = ontProperty
				.listSubProperties();
		...
		Iterator<? extends OntProperty> itrEquivalentProp = ontProperty
		...
		Iterator<? extends OntProperty> itrInverseOfProp = ontProperty
				.listInverseOf();
		...
		Iterator<? extends OntProperty> itrInverseProp = ontProperty
				.listInverse();
		...
		Iterator<? extends OntClass> itrDeclaringClass = ontProperty
...
/*		Iterator<Restriction> itrReferringRestriction = ontProperty.listReferringRestrictions();
		...
		System.out
				.println("HasReferringRestriction=" + hasReferringRestriction);
		...
		/*
		 * // Parse different types accordingly if (
		 * ontProperty.isDatatypeProperty() == true) { // Parse this Datatype
		 * Property DatatypeProperty datatypeProp =
		 * ontProperty.asDatatypeProperty(); System.out.println(
		 * "-Datatype Property begins"); System.out.println(
		 * "-Datatype Property ends"); } if ( ontProperty.isFunctionalProperty()
		 * == true) { // Parse this Functional Property FunctionalProperty
		 * functionalProp = ontProperty.asFunctionalProperty();
		 * System.out.println( "-Functional Property begins");
		 * System.out.println( "-Functional Property ends"); } if (
		 * ontProperty.isObjectProperty() == true) { // Parse this Object
		 * Property ObjectProperty objectProp = ontProperty.asObjectProperty();
		 * System.out.println( "-Object Property begins"); System.out.println(
		 * "-Object Property ends"); } if (
		 * ontProperty.isInverseFunctionalProperty() == true) { // Parse this
		 * Inverse Functional Property InverseFunctionalProperty
		 * inverseFunctionalProp = ontProperty.asInverseFunctionalProperty();
		 * System.out.println( "-Inverse Functional Property begins");
		 * System.out.println( "-Inverse Functional Property ends"); } if (
		 * ontProperty.isSymmetricProperty() == true) { // Parse this Symmetric
		 * Property SymmetricProperty symmetricProp =
		 * ontProperty.asSymmetricProperty(); System.out.println(
		 * "-Symmetric Property begins"); System.out.println(
		 * "-Symmetric Property ends"); } if (
		 * ontProperty.isTransitiveProperty() == true) { // Parse this
		 * Transitive Property TransitiveProperty transitiveProp =
		 * ontProperty.asTransitiveProperty(); System.out.println(
		 * "-Transitive Property begins"); System.out.println(
		 * "-Transitive Property ends"); }
		 */
	}
	...
	public static void parseClass(OntClass ontClass) {
		...
		Iterator<OntClass> itrEquivalentClass = ontClass
				.listEquivalentClasses();
		System.out
				.println("HasEquivalentClass=" + itrEquivalentClass.hasNext());
		...
		System.out.println("HasDisjointWithClass="
				+ itrDisjointWithClass.hasNext());
		...
		// No boolean hasMethod without any parameter either
		Iterator<OntProperty> itrDeclaredProperty = ontClass
				.listDeclaredProperties();
		System.out.println("HasDeclaredProperty="
				+ itrDeclaredProperty.hasNext());
		...
		if (ontClass.isEnumeratedClass()) {
			...
			Iterator<? extends OntResource> itrEnumClass = enumeratedClass
					.listOneOf();
		...
		if (ontClass.isUnionClass()) {
			...
			Iterator<? extends OntClass> itrUnionClass = unionClass
					.listOperands();
		...
		if (ontClass.isIntersectionClass()) {
			...
			IntersectionClass intersectionClass = ontClass
					.asIntersectionClass();
			System.out.println("-Intersection Class begins");
			Iterator<? extends OntClass> itrInterClass = intersectionClass
					.listOperands();
	...
	public static void parseRestriction(Restriction restriction) {
		...
		if (restriction.isAllValuesFromRestriction()) {
			...
			AllValuesFromRestriction allValues = restriction
		...
		if (restriction.isSomeValuesFromRestriction()) {
			...
			SomeValuesFromRestriction someValues = restriction
		...
		if (restriction.isCardinalityRestriction()) {
			CardinalityRestriction cardinality = restriction
		...
		if (restriction.isMaxCardinalityRestriction()) {
			MaxCardinalityRestriction maxCardinality = restriction
		...
		if (restriction.isMinCardinalityRestriction()) {
			MinCardinalityRestriction minCardinality = restriction
	...
	public static void displayKindInfoForClass(OntClass ontClass) {
		...
		System.out.println("isIntersectionClass="
	...
	public static void displayKindInfoForProperty(OntProperty ontProperty) {
		...
		System.out.println("isFunctionalProperty="
				+ ontProperty.isFunctionalProperty());
		System.out.println("isDatatypeProperty="
				+ ontProperty.isDatatypeProperty());
		System.out
				.println("isObjectProperty=" + ontProperty.isObjectProperty());
		System.out.println("isInverseFunctionalProperty="
				+ ontProperty.isInverseFunctionalProperty());
		System.out.println("isSymmetricProperty="
				+ ontProperty.isSymmetricProperty());
		System.out.println("isTransitiveProperty="
	...
	public static void displayKindInfoForRestriction(Restriction restriction) {
		...
		System.out.println("---isAllValuesFromRestriction="
		...
		System.out.println("---CardinalityRestriction="
				+ restriction.isCardinalityRestriction());
		System.out.println("---hasValueRestriction="
				+ restriction.isHasValueRestriction());
		System.out.println("---isMaxCardinalityRestriction="
				+ restriction.isMaxCardinalityRestriction());
		System.out.println("---isMinCardinalityRestriction="
